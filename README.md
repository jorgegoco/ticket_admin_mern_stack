...
```
  git clone git@github.com:jorgegoco/ticket_admin_mern_stack.git
...
Feel free to check the [issues page](https://github.com/jorgegoco/ticket_admin_mern_stack/issues).
